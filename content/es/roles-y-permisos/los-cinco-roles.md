...
# Los cinco roles y para qué sirve cada uno

**En resumen:** Barberlytics tiene cinco roles. Al crear a alguien del equipo eliges uno, y en **Configuración › Permisos** ves y ajustas lo que puede hacer cada uno.
...
| **Recepcionista** | «Este rol tiene permisos para registrar citas y hacer check in y check out. Generalmente se asigna a las secretarias de la barbería.» En la pantalla de Permisos aparece como **Recepción - mostrador de recepción** |
...
Al usar **Equipo › Acciones › Crear miembro del equipo**, la pantalla muestra una tarjeta por rol con su descripción. Eliges una y tocas **Crear**.
...
**¿Puedo crear un rol nuevo, por ejemplo «Gerente de turno»?**
