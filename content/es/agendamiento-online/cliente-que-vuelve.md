---
id: agendamiento-online/cliente-que-vuelve
...
**En resumen:** cuando el celular ya está en tu barbería, la página saluda al cliente por su nombre y le deja lista su última visita: la misma sede, el mismo servicio y el mismo barbero. Solo elige el día y la hora y toca **Continuar**.

![La bienvenida con la última visita preseleccionada y las horas disponibles](/assets/es/agendamiento-online/como-reserva-tu-cliente/bienvenida.png)

## Qué ve

| Parte | Qué muestra |
|---|---|
| Saludo | «Bienvenido de nuevo, Laura.» y «Recordamos tu última visita para reservar más rápido. Elige tu fecha y hora para continuar.» |
| **Elegir algo diferente** | Botón para ir al flujo completo y escoger otra cosa |
...
Toca **Cambiar** en la tarjeta que quiera cambiar (por ejemplo, otro barbero) y deja las demás como estaban. Si quiere empezar de cero, **Elegir algo diferente**.

## Preguntas frecuentes

**¿Cómo sabe la página quién es?**
Por el celular. Si ese número ya está en **Clientes**, lo reconoce y usa su última cita.

**¿Y si su barbero de siempre no tiene horas ese día?**
