---
id: agendamiento-online/elegir-sede-servicio-y-barbero
...
**En resumen:** en el flujo completo, arriba se ven los pasos **Sede › Servicio/Barbero › Fecha y hora › Confirmar**. El cliente toca su sucursal, luego un servicio y luego un barbero (o **Sin preferencia**), y pasa con **Siguiente**.

## Sede

![La elección de sede, con una tarjeta por sucursal](/assets/es/agendamiento-online/como-reserva-tu-cliente/elegir-diferente.png)

Una tarjeta por sucursal con su nombre, su dirección, su horario («08:00 a 23:50») y **Detalles de la sede**. Al tocar una pasa al siguiente paso. Si tu barbería tiene una sola sucursal, igual la ve.

## Servicio

![La lista de servicios por categoría, con duración y precio](/assets/es/agendamiento-online/como-reserva-tu-cliente/servicios.png)

- Dos pestañas: **Servicios** y **Barberos**. **Barberos** está apagada, con la ayuda «Selecciona un servicio», hasta que elige uno.
- Filtro por categoría: **Todos** y cada categoría de tus servicios.
- Cada servicio muestra su duración («0 h 30 min») y su precio «desde» («$50.00 &UP»): el precio final depende del barbero.
...
- Abajo dice «Selecciona un barbero»; al elegir uno aparece **Siguiente**.

## Preguntas frecuentes

**¿Por qué el precio del servicio dice «&UP»?**
