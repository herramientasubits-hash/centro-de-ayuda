...
# El equipo es de la empresa y se activa en cada sucursal

**En resumen:** todas las personas de tu equipo pertenecen a la empresa. En **Equipo** solo ves a las que están **activadas en la sucursal** que elegiste arriba.

## Cómo funciona

- Una persona se crea **una sola vez**.
- Después la **activas** en cada sucursal donde trabaja.
- Si la activas en dos sucursales, es la misma persona en las dos: no se duplica.
- La lista de **Equipo** cambia según la sucursal que elegiste.

Por ejemplo: si tu empresa tiene 21 barberos por comisión y en una sucursal solo activaste a 10, esa sucursal muestra 10.
...
**¿Cambiar de sucursal cambia el equipo que veo?**
Sí. Cada sucursal muestra solo a las personas que tiene activadas.
